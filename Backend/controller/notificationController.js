...
return res
.status(403)
.json({ message: "Only lecturers, President, or PRO can send reminders" });
}
...
return res
.status(403)
.json({ message: "Only lecturers, President, or PRO can post materials" });
}
...
if (!cloudDoc)
  return res.status(404).json({ message: "Document not found in material" });
...
return res
.status(403)
.json({ message: "Only lecturers, President, or PRO can post announcements" });
}
...
return res
.status(403)
.json({ message: "Only lecturers, President, or PRO can post events" });
}
...
return res
.status(403)
.json({ message: "Only lecturers, President, or PRO can edit events" });
}
...
return res
.status(403)
.json({ message: "Only lecturers, President, or PRO can edit announcements" });
}
