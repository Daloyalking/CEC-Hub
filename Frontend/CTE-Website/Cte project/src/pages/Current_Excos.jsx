...
return ( <div className="p-6"> <h1 className="text-3xl font-bold text-center mb-8 text-blue-700">
Department of Computer Engineering EXCOS </h1>
  ...
  {sortedExcos.length === 0 ? (
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
      {sortedExcos.map((exco) => (
        <div
          key={exco._id}
          className="bg-white rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300 overflow-hidden border"
        >
